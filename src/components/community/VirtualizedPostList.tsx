              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  <motion.button
                    ...
                    animate={{ scale: likeAnimations[post.id] ? 1.2 : 1 }}
                  >
                    <Heart
                      className={`h-6 w-6 transition-colors duration-300 ${
                        post.likes.includes('current-user') // You'll need to pass actual user ID
                ...
                <motion.button
                  ...
                  className="h-8 w-8 p-0"
                  animate={{ scale: bookmarkAnimations[post.id] ? 1.2 : 1 }}
                >
