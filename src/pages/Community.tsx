    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-lg p-8 text-center shadow-lg max-w-md">
          ...
          <p className="text-gray-600 mb-6">Connect with like-minded believers and share your journey.</p>
        ...
        <div className="max-w-md mx-auto">
          ...
          <div className="space-y-0">
            {getFilteredPosts().map((post, index) => (
              ...
              >
                <Card className="rounded-none border-x-0 border-t-0 last:border-b-0 shadow-none">
                  {/* Post Header */}
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <div className="flex items-center space-x-2">
                          ...
                          {post.isAdmin && (
                            <Badge className="bg-gradient-to-r from-purple-600 to-pink-600 text-white text-xs px-2 py-0">
                              Leader
                            </Badge>
                          )}
                        </div>
