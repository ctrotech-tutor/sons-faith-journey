...
import { User, Hash, Mail, Lock, Phone, MapPin, HelpCircle, ArrowLeft, Eye, EyeOff, Loader2 } from 'lucide-react';
...
const Signup = () => {
  ...
  return (
    ...
    >
      ...
      <div>
        <p className="text-[#47569e] dark:text-purple-200 text-sm font-normal leading-normal pb-3 pt-1 px-4 text-center">Already have an account?</p>
