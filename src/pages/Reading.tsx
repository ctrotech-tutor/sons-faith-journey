...
export default function ReadingPage() {
  const { user } = useAuth();
  const { userStats, updateReadingProgress, getTodayDayNumber } = useActivitySync();
          ...
          <Card className="shadow-xl">
            <CardContent className="p-12 text-center">
              <div className="mb-6">
                ...
                <h2 className="text-3xl font-bold mb-4 text-gray-800">Join Your Reading Journey</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div className="text-center p-4 bg-purple-50 rounded-lg">
                  ...
                  <h3 className="font-semibold text-gray-800">Daily Readings</h3>
                  <p className="text-sm text-gray-600">Structured 90-day plan</p>
                </div>
                ...
                <div className="text-center p-4 bg-green-50 rounded-lg">
                  ...
                  <h3 className="font-semibold text-gray-800">Growth Analytics</h3>
                  <p className="text-sm text-gray-600">Insights & achievements</p>
                </div>
              </div>
            </CardContent>
          </Card>
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-indigo-50">
      <div className="max-w-7xl mx-auto p-4 space-y-8">
        ...
        <motion.div
          ...
          className="text-center bg-gradient-to-r from-purple-600 via-blue-600 to-indigo-600 text-white p-8 rounded-2xl shadow-lg"
        >
